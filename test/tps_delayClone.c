...
static char msg3[TPS_SIZE] = "Checking for Copy-on-Write\n";
...
void *thread1(void* arg)
{
	...
	/*clones thread 2, transfer CPU to thread 3, and gets blocked*/
	sem_up(sem2);
        sem_down(sem1);
    
        /*Transfer CPU to thread 2, and gets blocked*/
	sem_up(sem2);
        sem_down(sem1);
